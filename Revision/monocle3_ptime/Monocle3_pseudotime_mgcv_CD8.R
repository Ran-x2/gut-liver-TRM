...
# root_cells=colnames(cds)[colData(cds)$tissue.celltype == "PB TCRab CD8ab Teff"]
...
write.csv(pseudotime_df, "revision/monocle3_ptime/PBTeff_LTeff_CD8_mgcv_monocle3_pseudotime.csv")
# pseudotime = read.csv("PBTeff_LTeff_CD8_monocle3_pseudotime.csv",row.names = 1)['pseudotime']
...
names(fits) <- genes
saveRDS(fits, 'revision/monocle3_ptime/mgcv_gam_models_PBTeff_LTeff_CD8_counts.rds')
...
#   }, error = function(e) NA)
# })
# saveRDS(gam.pval, 'revision/monocle3_ptime/gam_models_PBTeff_LTeff_CD8_counts.rds')
...
saveRDS(heatdata, 'revision/monocle3_ptime/PBTeff_LTeff_CD8_monocle3_heatdata_mgcv_gam.rds')
write.table(heatdata, 'revision/monocle3_ptime/PBTeff_LTeff_CD8_monocle3_ptime_mgcv_gam.csv', sep = ',')
...
ggsave("revision/monocle3_ptime/PBTeff_LTeff_CD8_monocle3_time_mgcv_gam.pdf", plot = ptime_heatmap, width = 5, height = 6, dpi = 300)
