...
mat = read.csv('CD4_GLIPH2_donor_separated_motif_shared_normalized_mean.csv', row.names = 1, check.names = FALSE)
mat <- as.matrix(mat)
...
dev.copy(jpeg,'cd4_GLIPH2_chord_donor_averaged_total_clone_normalized.png', width=14, height=14, units="in", res=500)
dev.off()
## ===========================================================
# CD8 GLIPH2 chord diagram
mat = read.csv('CD8_GLIPH2_donor_separated_motif_shared_normalized_mean.csv', row.names = 1, check.names = FALSE)
mat <- as.matrix(mat)
